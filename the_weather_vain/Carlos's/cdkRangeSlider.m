...
#import "cdkRangeSliderKnobLayer.h"
#import "cdkRangeSliderTrackLayer.h"

@implementation cdkRangeSlider{
    
    cdkRangeSliderTrackLayer* _trackLayer;
    cdkRangeSliderKnobLayer* _upperKnobLayer;
    cdkRangeSliderKnobLayer* _lowerKnobLayer;
...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        _trackLayer = [cdkRangeSliderTrackLayer layer];
        _trackLayer.slider = self;
      //  _trackLayer.backgroundColor = [UIColor blueColor].CGColor;
        [self.layer addSublayer:_trackLayer];
        
        _upperKnobLayer = [cdkRangeSliderKnobLayer layer];
     ...
     //   _upperKnobLayer.backgroundColor = [UIColor greenColor].CGColor;
        ...
        _lowerKnobLayer = [cdkRangeSliderKnobLayer layer];
